...
try {
    ...
    res.render('musical/index',{instruments,carouselItems});
...
router.get('/posts/:id',async(req,res)=>{
    try {
        ...
        res.render('musical/show',{instrument});
...
router.get('/posts/:id/edit',async(req,res)=>{
    try {
        ...
        res.render('musical/edit',{instrument});
...
router.get('/posts/:id/admin/comments',async(req,res)=>{
    try {
        ...
        res.render('musical/commentAdmin',{comments});
